...
public struct SchellyAlertOptions {
    var title: String
...
public func customAlert(options: SchellyAlertOptions, completion: @escaping (String) -> Void) {
...
private func showAlert(alert: UIAlertController, with options: SchellyAlertOptions) {
